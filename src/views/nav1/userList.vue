<template>
  <section>
    ...
    <!--列表-->
    <el-table :data="persons" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
              style="width: 100%;">
...
<script>
  ...
  import {getPersonListPage, removePerson, batchremovePerson, editPerson, addPerson} from '../../api/api';
